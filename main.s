...
.L162:
	...
	movapd	%xmm0, %xmm2
	divsd	%xmm1, %xmm2
	cvtsi2sd	65704(%rbp), %xmm1
	cvtsi2sd	65712(%rbp), %xmm0
	call	lerp
	cvttsd2si	%xmm0, %eax
	movl	%eax, 65696(%rbp)
	movl	$255, %ecx
	...
	movapd	%xmm0, %xmm2
	divsd	%xmm1, %xmm2
	cvtsi2sd	65700(%rbp), %xmm1
	cvtsi2sd	65708(%rbp), %xmm0
	call	lerp
	cvttsd2si	%xmm0, %eax
	movl	%eax, 65692(%rbp)
	movl	$255, %r10d
