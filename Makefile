...
obsolete_1:
	gcc -std=c17 main.c -I "$(SDL2b)\include" -L "$(SDL2b)\lib" -Wall -Wextra -lmingw32 -lSDL2main -lSDL2 -o main

obsolete_2:
	@echo $(WORKDIR)
	gcc -std=c17 $(PROGRAM).c -I "$(SDL2)\include" -L "$(SDL2)\lib" -Wall -Wextra -lmingw32 -lSDL2main -lSDL2 -lSDL2_image -g $(shell sdl2-config --cflags --libs) -o $(PROGRAM)
